...
public class TreeColors {
    public static Vector3f getColorForLevel(int level) {
        switch(level) {
            ...
            case 6:  return HexToVec3.hexToVec3("#a1935f");
            case 7:  return HexToVec3.hexToVec3("#6c576e");
            case 8:  return HexToVec3.hexToVec3("#e2d5d7");
            case 9:  return HexToVec3.hexToVec3("#a32439");
            case 10: return HexToVec3.hexToVec3("#0f0f0f");
            default: return HexToVec3.hexToVec3("#ffffff");
        }
    }
}