...
#define MAX_ISLANDS 8000
#define MIN_ISLAND_RADIUS 300.0f
#define MAX_ISLAND_RADIUS 1000.0f
#define MIN_MOUNTAIN_RADIUS 10.0f
#define MAX_MOUNTAIN_RADIUS 2000.0f
#define MAX_MOUNTAIN_HEIGHT 1000.0f
#define BASE_HEIGHT_RANGE 200.0f

#define WATER_LEVEL 50.0f
#define OCEAN_DEPTH 100.0f

extern int islandCount;
extern int islandsInitialized;
